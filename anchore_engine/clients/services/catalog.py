...
class CatalogClient(InternalServiceClient):
    ...
    def add_image(self, tag=None, digest=None, dockerfile=None, annotations=None, created_at=None, from_archive=False, allow_dockerfile_update=False, manifest=None):
        """
