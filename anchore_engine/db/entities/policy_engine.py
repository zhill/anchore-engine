...
class AnalysisArtifact(Base):
    ...
    image_id = Column(String, primary_key=True)
    image_user_id = Column(String, primary_key=True)
    analyzer_id = Column(String, primary_key=True) # The name of the analyzer (e.g. layer_info)
    analyzer_artifact = Column(String, primary_key=True) # The analyzer artifact name (e.g. layers_to_dockerfile)
    analyzer_type = Column(String, primary_key=True) # The analyzer type (e.g. base, user, or extra)
...
class Image(Base):
    ...
    id = Column(String, primary_key=True)
    user_id = Column(String, primary_key=True)  # Images are namespaced in the system to prevent overlap
...
class DistroMapping(Base):
    ...
    to_distro = Column(String) # The distro to use instead of the pk distro to do cve checks
